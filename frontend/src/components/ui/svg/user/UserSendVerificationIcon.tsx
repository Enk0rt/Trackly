...
const UserSendVerificationIcon: React.FC<Props> = (props) => (
    <svg height="800px" width="800px" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg"
         viewBox="0 -3 25.951 25.951" {...props}>
<g>
	<path fill="currentColor" d="M3,0.225h18c1.656,0,3,1.344,3,3v10c0,0.313-0.062,0.609-0.15,0.893l-2.056-1.832
    ...
    <g>
		<path fill="currentColor" d="M20,13.741v2.434c-3.227,0-7.5,1.564-7.5,9.551c1.412-5.096,3.314-5.488,7.5-5.488v2.473
...
export default UserSendVerificationIcon;
