    ...
    return (
        <form onSubmit={handleSubmit(onSubmit)}>
          ...
          <div className='flex gap-5 items-center'>
              ...
              <Link href='/'
                    className='w-fit mt-2 block text-[#33674E] dark:text-white underline underline-offset-2 transition duration-300 ease-in-out will-change-transform origin-center hover:scale-110 opacity-50 hover:opacity-100'>To home page</Link>
          </div>
        </form>
    );
};
